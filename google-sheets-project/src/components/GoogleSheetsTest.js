        ...
        <div className="left-panel">
            ...
            <div className="info-panel">
              ...
              <div className="info-content">
                <div className="info-item">
                  ...
                  <span className="info-value">{spreadsheetInfo.properties?.title}</span>
                </div>
                <div className="info-item">
                  <span className="info-label">Sheets:</span>
                  <span className="info-value">
                    {spreadsheetInfo.sheets?.map((s) => s.properties.title).join(", ") || "None"}
                  </span>
                </div>
              </div>
              <button onClick={getSpreadsheetInfo} disabled={loading} className="refresh-btn">
                🔄 Refresh Info
              </button>
            </div>
          )}
          ...
          <div className="controls">
            ...
            <div className="action-buttons">
              <button onClick={handleReadSheet} disabled={loading} className="read-btn">
                📖 Read Sheet
              </button>
              <button onClick={handleCreateSheet} disabled={loading} className="create-btn">
                ➕ Create Sheet
              </button>
            </div>
          </div>
