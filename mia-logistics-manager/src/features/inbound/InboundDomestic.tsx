...
// Real service functions (commented out for now due to Google Sheets setup)
// import {
...
// Temporary empty functions until Google Sheets is configured
const getInboundDomesticItems = async (): Promise<InboundDomesticItem[]> => {
  // Return empty array for now - will be replaced with real service
  return [];
};

const addInboundDomesticItem = async (
  item: Omit<InboundDomesticItem, 'id' | 'createdAt' | 'updatedAt'>
): Promise<void> => {
  console.log('Adding item (mock):', item);
  // Will be replaced with real service
};

const updateInboundDomesticItem = async (
  id: string,
  updates: Partial<InboundDomesticItem>
): Promise<void> => {
  console.log('Updating item (mock):', id, updates);
  // Will be replaced with real service
};

const deleteInboundDomesticItem = async (id: string): Promise<void> => {
  console.log('Deleting item (mock):', id);
  // Will be replaced with real service
};
